;(function(factory){
	...
	return primish({
		 ...
		 * @param {Object=} a element to bind to, optional, inferred to this.element
		 * @param {Object} b object to bind to template
		 */
		bindRivets: function(a, b){
			typeof b === 'undefined' && (b = a, a = this.element);
			this.boundRivets = this.rivets.bind(a, b);
		},
