;(function(factory){
	...
	if (typeof define == 'function' && define.amd){
		define(['./index', './model', './slick'], factory);
...
}).call(this, function(epic, Model, Slick){
	'use strict';
	...
	var collection = primish({
		...
		reset: function(models, quiet){
			...
			_.forEach(models, _.bind(this, this.addModel));

			// if a model is destroyed, remove from the collection
			this.on('destroy', _.bind(this, this.removeModel));
