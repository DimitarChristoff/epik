;(function(factory){
	...
	var util = {
		...
		/**
		 * @description slice arguments and return array
		 * @param {Object|Array} args arguments object
		 * @param {Number} pos offset
		 * @returns {Array}
		 */
		slice: function(args, pos){
			// much faster than Array.prototype.slice in v8
			pos = ~~pos;
			var i = -1,
				l = args.length - pos,
				x = Array(l);
