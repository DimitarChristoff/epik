;(function(factory){
	...
	var slice = Array.prototype.slice,
		/**
		 * @description object property not to be enumerable where supported
		 * @param {object} obj to configure / add to
		 * @param {string} prop name to add as object
		 * @returns {object}
		 */
		hideProperty = function(obj, prop){
			return obj[prop] = obj[prop] || {}, primish.define(obj, prop, {enumerable: false, value: obj[prop]}), obj[prop];
		};
	...
	emitter = primish({
		...
		listenTo: function(obj, event, fn){
			var t = typeof event,
				...
				subscribers = obj._subscribers || hideProperty(obj, '_subscribers');
		...
		trigger: function(event){
			...
			if (subscribers && (events = subscribers[event] || subscribers['*'] || {})){
